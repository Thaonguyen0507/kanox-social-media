    ...
    setConfirmAction({
      ...
      action: async () => {
        try {
          ...
          // Gọi API khóa tài khoản (set isLocked = true)
          await adminService.updateUserLockStatus(id, true);
    ...
    setConfirmAction({
      ...
      action: async () => {
        try {
          ...
          // Gọi API mở khóa tài khoản (set isLocked = false)
          await adminService.updateUserLockStatus(id, false);
